<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="RealTimeConverterCurrencyYahooAPI.Default" %>
...
<body>
    <form id="form1" runat="server">
        <table class="CSSTableGenerator">
            ...
            <tr>
                <td class="auto-style1"><span>Convert this amount</span>
                </td>
                <td>
                    <asp:TextBox ID="txtAmount" runat="server" ClientIDMode="Static" MaxLength="12" Text="1" TextMode="Number" Height="43px" Width="333px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="auto-style1"><span>From this currency:</span>
                </td>
                <td>
            ...
            <tr>
                <td class="auto-style1">To this currency:
                </td>
                <td>
            ...
            <tr>
                <td colspan="2" class="auto-style2">
                    &nbsp;<input id="submit" type="button" value="Convert" /></td>
            </tr>
            <tr class="result">
